...
git clone https://github.com/Unetus/movidesk-automation.git
...
**Matheus (Unetus)**
- GitHub: [@Unetus](https://github.com/Unetus)
- Email: unetusplays@gmail.com
...
Para dúvidas ou sugestões, abra uma [Issue](https://github.com/Unetus/movidesk-automation/issues).
